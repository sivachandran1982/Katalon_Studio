...
public class Shop {
	...
	def static void addToCart(String productName,String urlProduct){
		...
		WebUI.waitForElementPresent(findTestObject('NonAngular_Objects/Shop page/btnAddToCart'), GlobalVariable.waitPresentTimeout)
		WebUI.click(findTestObject('NonAngular_Objects/Shop page/btnAddToCart'))

		WebUI.waitForElementPresent(findTestObject('NonAngular_Objects/Shop page/lnkViewCart'), GlobalVariable.waitPresentTimeout)
		WebUI.click(findTestObject('NonAngular_Objects/Shop page/lnkViewCart'))

		WebUI.verifyElementPresent(findTestObject('NonAngular_Objects/Shop page/btnProceed'), GlobalVariable.waitPresentTimeout)
	}
	...
	def static void applyCouponAndAddToCart(String productName,String urlProduct,String coupon){
		...
		WebUI.setText(findTestObject('NonAngular_Objects/Shop page/txtCoupon'), coupon)
		WebUI.click(findTestObject('NonAngular_Objects/Shop page/btnApply'))
